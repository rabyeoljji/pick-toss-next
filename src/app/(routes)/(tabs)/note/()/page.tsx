import { QuizNoteProvider } from '@/views/note/quiz-note/context/quiz-note-context'
import Header from '@/views/note/quiz-note/components/header'
import NoteList from '@/views/note/quiz-note/components/note-list'
import SwipeableNoteCard from '@/views/note/quiz-note/components/swipeable-note-card'
import AddNoteMenu from '@/views/note/quiz-note/components/add-note-menu'
