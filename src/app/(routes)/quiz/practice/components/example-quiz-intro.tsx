...
export default function ExampleQuizIntro({ quizzes, className }: Props) {
  return (
    <div className={className}>
      ...
      >
        <div className="flex flex-col items-center gap-[8px]">
          <div className="text-h3-bold text-gray-08">연습 퀴즈</div>
          <div className="text-body1-medium text-gray-07">{getCurrentDate()}</div>
        </div>
        <DocumentListIcon />
        <div className="flex flex-col gap-[8px]">
          {Object.entries(getEachQuizTypeCount(quizzes)).map(([key, value]) => (
            <div
              key={key}
